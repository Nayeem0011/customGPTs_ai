  ...
  return (
    <section className="flex flex-col justify-center items-center py-12 lg:py-16 px-4 gap-10">
      ...
      <div className="flex flex-col items-center gap-3">
        <h1 className="w-full max-w-184 text-center text-[16px] sm:text-[20px] md:text-[24px] lg:text-[32px] xl:text-[36px] 2xl:text-[40px] font-geist font-medium leading-[130%] text-[#1a1a1a]">
          Driver real-worlds{" "}
          <span className="text-[#9ca3af]">results with AI</span>
        </h1>
        <p className="text-center text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] font-geist font-normal leading-[160%] text-[#666]">
            ...
            <div className="relative p-3">
              ...
              >
                ...
                <div className="relative text-left">
                  ...
                  <p className="text-right text-[36px] sm:text-[40px] md:text-[48px] lg:text-[64px] xl:text-[96px] 2xl:text-[120px] font-geist font-extralight leading-none text-[#4A4A59] -mt-4">
                    {card.stat}
                  </p>
                ...
                <div className="relative mt-6 text-left">
                  ...
                  <p className="font-geist text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] text-gray-500 leading-relaxed max-w-60">
                    {card.desc}
                  </p>
                </div>
              </div>
      ...
      <button className="mt-2 px-3.5 sm:px-3.75 md:px-4 lg:px-5 xl:px-6 2xl:px-7 py-1.5 sm:py-2 md:py-2.5 text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] font-geist text-gray-800 border border-gray-300 rounded-full bg-transparent hover:bg-gray-50 transition-all">
        Learn more about us
      </button>
    </section>
  )
