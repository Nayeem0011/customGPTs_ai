  ...
  return (
    <section className="flex flex-col justify-center items-center py-12 lg:py-16 px-4 gap-10">
      ...
      <div className="flex flex-col items-center gap-3">
        <h1 className="w-full max-w-184 text-center text-[32px] sm:text-[40px] lg:text-[48px] font-medium leading-[130%] text-[#1a1a1a]">
          Driver real-worlds{" "}
            ...
            <div className="relative z-10 p-3">
              ...
              >
                ...
                <div className="relative z-10 mt-6 text-left">
                  ...
                  <p className="text-[13px] text-gray-500 leading-relaxed max-w-60">
                    {card.desc}
                  </p>
                </div>
              </div>
