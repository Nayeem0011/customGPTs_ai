...
const Trusted = () => {
    return (
        <div className='flex flex-col gap-10 lg:gap-14 max-w-7xl mx-auto w-full px-4 sm:px-6 pt-12 lg:pt-20 mb-12 lg:mb-20'>

            {/* Top heading + description */}
            <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-0'>
                <h1 className='text-[#9898A7] font-medium text-[28px] sm:text-[36px] lg:text-[48px] leading-[130%]'>
                    Why startup choose <br />
                    <span className='text-[#4A4A59]'>CustomGPT.ai</span>
                </h1>
                <p className='text-[#8B929E] font-normal text-[14px] sm:text-[16px] leading-[160%]'>
                    Built for organizations. AI that's easy, secure, <br className="hidden sm:block" />
                    and represents us like a star team member.
                </p>
            </div>
            ...
            <div className='flex flex-col lg:flex-row items-stretch justify-center gap-6'>
                ...
                {/* Card 1 (Blue gradient) */}
                <div className='relative w-full lg:w-[598px] rounded-3xl lg:rounded-4xl overflow-hidden bg-[radial-gradient(120.74%_124.92%_at_7.26%_100%,#326DE4_0%,#628FFD_100%),radial-gradient(167.08%_140.48%_at_79.5%_0%,rgba(255,255,255,0.06)_0%,rgba(255,255,255,0)_100%)] shadow-[inset_1.01px_0.94px_4.09px_0px_#FFFFFF21,inset_1.9px_1.77px_8.17px_0px_#FFFFFF21]'>

                    {/* Content on top */}
                    <div className='flex items-start justify-start flex-col gap-4 lg:gap-6 pl-6 sm:pl-8 pt-6 sm:pt-8 z-10 relative'>
                        <h3 className='text-[#FFFFFF] font-semibold text-[22px] sm:text-[28px] lg:text-[32px] leading-[130%]'>
                            Enterprise-grade data security
                        </h3>

                        <div className='text-[#FFFFFF] flex gap-1.5 flex-wrap'>
                            <SparkIcon />
                            <span className='font-semibold text-[14px] sm:text-[16px] leading-[130%]'>Full data protection:</span>
                            <span className='font-normal text-[15px] sm:text-[18px] leading-[130%]'>No training or sharing your data</span>
                        </div>

                        <div className='text-[#FFFFFF] flex gap-1.5 flex-wrap'>
                            <SparkIcon />
                            <span className='font-semibold text-[14px] sm:text-[16px] leading-[130%]'>Enterprise security:</span>
                            <span className='font-normal text-[15px] sm:text-[18px] leading-[130%]'>SOC-2 type II, GDPR, full encryption</span>
                        </div>

                        <button className='relative z-20 rounded-xl border border-[#CBCBCB80] bg-[#FFFFFF] py-3 lg:py-3.5 px-6 lg:px-9 font-medium text-[#4A4A59] text-[14px] lg:text-[16px] leading-[120%]'>
                            Explore trust center
                        </button>
                    </div>

                    {/* Image below button on mobile, absolute on desktop */}
                    <div className='
                        block lg:hidden
                        relative w-full h-[220px] mt-4
                    '>
                        <Image src={card_image} alt="Company logo" fill className="object-contain object-right-bottom" />
                    </div>
                    <div className='hidden lg:block absolute w-[85%] h-[85%] -right-30 -bottom-35'>
                        <Image src={card_image} alt="Company logo" className="object-contain object-bottom-right" />
                    </div>

                    {/* Desktop spacer */}
                    <div className='hidden lg:block h-[462px] absolute inset-0 -z-10' />
                </div>

                {/* Card 2 (Light gray) */}
                <div className='relative w-full lg:w-[598px] rounded-3xl lg:rounded-4xl overflow-hidden bg-[#F2F3FA] shadow-[inset_1.01px_0.94px_4.09px_0px_#FFFFFF21,inset_1.9px_1.77px_8.17px_0px_#FFFFFF21]'>

                    {/* Content on top */}
                    <div className='flex items-start justify-start flex-col gap-4 lg:gap-6 pl-6 sm:pl-8 pt-6 sm:pt-8 z-10 relative'>
                        <h3 className='text-[#4A4A59] font-semibold text-[22px] sm:text-[28px] lg:text-[32px] leading-[130%]'>
                            Answers you trust
                        </h3>
                        ...
                        <div className='text-[#4A4A59] flex items-start gap-1.5'>
                            <SparkIcon2 />
                            <div className='block'>
                                <span className='font-semibold text-[14px] sm:text-[16px] leading-[130%]'>
                                    Full data protection:
                                </span>
                                <span className='font-normal text-[15px] sm:text-[18px] leading-[130%]'>
                                    Third-party verified #1 for anti-hallucination{' '}
                        ...
                        <div className='text-[#4A4A59] flex gap-1.5 flex-wrap'>
                            <SparkIcon2 />
                            <span className='font-semibold text-[14px] sm:text-[16px] leading-[130%]'>Enterprise security:</span>
                            <span className='font-normal text-[15px] sm:text-[18px] leading-[130%]'>Every response has a link directly to its source</span>
                        </div>
                    ...
                    <div className='
                        ...
                        relative w-full h-[220px] mt-4
                    '>
                        <Image src={card_image2} alt="Company logo" fill className="object-contain object-right-bottom" />
                    </div>
                    <div className='hidden lg:block absolute w-[492px] h-[492px] -right-28 -bottom-43'>
                        <Image src={card_image2} alt="Company logo" className="object-contain object-bottom-right" />
                    </div>
