  ...
  return (
    <section>
      <div className="flex flex-col items-center pt-1 sm:pt-8 md:pt-12 lg:pt-18">
        ...
        <h1 className="text-white font-clash font-semibold text-[32px] sm:text-[36px] md:text-[40px] lg:text-[48px] xl:text-[64px] 2xl:text-[80px] leading-[110%] tracking-[-1px] text-center align-middle mt-1 md:mt-2 mb-4 md:mb-5 lg:mb-6">
        ...
        <p className="text-white mb-5 sm:mb-6 md:mb-7 lg:mb-8 font-geist font-normal text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[20px] 2xl:text-[24px] leading-[140%] tracking-[-0.7px] text-center align-middle">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 md:gap-4 mb-6 sm:mb-7 md:mb-8 lg:mb-10 flex-wrap justify-center">
          <div className="flex items-center gap-1 md:gap-3 lg:gap-3 rounded-[10px] border border-white/20 px-2.5 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3 font-medium leading-[120%] align-middle text-white text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px]">
            ...
            <span className="font-geist">Industry-leading accuracy</span>
          </div>
          <div className="flex items-center gap-1 md:gap-3 lg:gap-3 rounded-[10px] border border-white/20 px-2.5 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3 font-medium leading-[120%] align-middle text-white text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px]">
            <Image src={icon2} alt="shield" className="w-3 h-3 md:w-4 md:h-4" />
            <span className="font-geist">Zero data sharing & training</span>
          </div>
        </div>
        <div className="flex items-center gap-3 md:gap-4 flex-wrap justify-center">
          <button
            className="rounded-lg md:rounded-xl px-3 py-2 sm:px-5 sm:py-2.5 md:px-7 md:py-3 lg:px-8 lg:py-3.5 text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] font-geist font-medium text-white transition-opacity hover:opacity-90 cursor-pointer"
            style={{
          ...
          <button
            className="rounded-lg md:rounded-xl px-3 py-2 sm:px-5 sm:py-2.5 md:px-7 md:py-3 lg:px-8 lg:py-3.5 text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] font-geist font-medium text-[#4A4A59] bg-white hover:bg-gray-50 transition-colors cursor-pointer"
