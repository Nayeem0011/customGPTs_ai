  ...
  return (
    <section>
      <div className="flex flex-col items-center pt-1 sm:pt-8 md:pt-12 lg:pt-18">
        <p className="text-white font-normal text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] leading-[140%] tracking-[0px] text-center align-middle uppercase">
          #1 AI AGENT FOR BUSINESSES
        </p>
        <h1 className="text-white font-semibold text-[32px] sm:text-[36px] md:text-[40px] lg:text-[48px] xl:text-[64px] 2xl:text-[80px] leading-[110%] tracking-[-1px] text-center align-middle mt-1 md:mt-2 mb-4 md:mb-5 lg:mb-6">
        ...
        <p className="text-white mb-5 sm:mb-6 md:mb-7 lg:mb-8 font-normal text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[20px] 2xl:text-[24px] leading-[140%] tracking-[-0.7px] text-center align-middle">
